...
public class Collision_D1 : MonoBehaviour
{
    ...
    void OnTriggerStay(UnityEngine.Collider collision)
    {
        ...
        {
            //Debug.Log("Collision loin à droite détectée !");
            playLineaire();
            nbr_collisions++;
        }
    }
...
[CustomEditor(typeof(Collision_D1))]
public class VibrationManagerEditor6 : Editor
{
    // instance is the object that is being edited/displayed
    private Collision_D1 instance;
    private void OnEnable()
    {
        instance = (Collision_D1)target;
    }
}

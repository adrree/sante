...
public class Collision_D2 : MonoBehaviour
{
    ...
    void OnTriggerStay(UnityEngine.Collider collision)
    {
        ...
        {
            //Debug.Log("Collision proche à droite détectée !");
            playLineaire();
            nbr_collisions++;
        }
    }
    ...
    public async void playLineaire()
    {
        ...
        for (int i = 0; i < steps; i++)
        {
            ...
            driver.SetMessage(new byte[5] { 0, 0, 0, intensity0, Driver.EndMarker });
            await Task.Delay(40);
            driver.SetMessage(getDefaultMessage());
        }
    }
...
[CustomEditor(typeof(Collision_D2))]
public class VibrationManagerEditor5 : Editor
{
    // instance is the object that is being edited/displayed
    private Collision_D2 instance;
    private void OnEnable()
    {
        instance = (Collision_D2)target;
    }
}

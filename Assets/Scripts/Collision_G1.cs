...
public class Collision_G1 : MonoBehaviour
{
    ...
    void OnTriggerStay(UnityEngine.Collider collision)
    {
        ...
        {
            //Debug.Log("Collision loin à gauche détectée !");
            playLineaire();
            nbr_collisions++;
        }
    }
...
[CustomEditor(typeof(Collision_G1))]
public class VibrationManagerEditor3 : Editor
{
    // instance is the object that is being edited/displayed
    private Collision_G1 instance;
    private void OnEnable()
    {
        instance = (Collision_G1)target;
    }
}

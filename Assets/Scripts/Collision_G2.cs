...
public class Collision_G2 : MonoBehaviour
{
    ...
    void OnTriggerStay(UnityEngine.Collider collision)
    {
        ...
        {
            //Debug.Log("Collision proche à gauche détectée !");
            playLineaire();
            nbr_collisions++;
        }
    }
...
[CustomEditor(typeof(Collision_G2))]
public class VibrationManagerEditor4 : Editor
{
    // instance is the object that is being edited/displayed
    private Collision_G2 instance;
    private void OnEnable()
    {
        instance = (Collision_G2)target;
    }
}

...
public class Collision_M1 : MonoBehaviour
{
    ...
    void OnTriggerStay(UnityEngine.Collider collision)
    {
        ...
        {
            //Debug.Log("Collision loin devant détectée !");
            playLineaire();
            nbr_collisions++;
        }
    }
...
[CustomEditor(typeof(Collision_M1))]
public class VibrationManagerEditor7 : Editor
{
    // instance is the object that is being edited/displayed
    private Collision_M1 instance;
    private void OnEnable()
    {
        instance = (Collision_M1)target;
    }
}
